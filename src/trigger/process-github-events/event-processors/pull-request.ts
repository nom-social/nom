...
You can use explore_file with ref=${pull_request.head.sha} to read specific file contents, get_pull_request with pull_number=${pull_request.number} for full PR details including diff, and add a relevant meme image when appropriate.`;
