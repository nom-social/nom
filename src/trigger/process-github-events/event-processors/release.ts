...
You can use explore_file with ref=${release.tag_name} to read files at the release tag, compare_refs to diff between tags (e.g. previous...${release.tag_name}), get_pull_request if you need PR context, and add a relevant meme image when appropriate.`;
